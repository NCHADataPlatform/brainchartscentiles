...
- [calibration_example.qmd](calibration_example.qmd). calibration_example.qmd: Data set up and calibration for a small site calibration using the Healthy Brain Network dataset [[2]](#2).
- [calibration_example_hbn_accuracy.qmd](calibration_example_hbn_accuracy.qmd) calibration_example_hbn_accuracy.qmd: An evaluation of the accuracy of this centile-informed method on a small sample using the public Healthy Brain Network dataset [[2]](#2).
